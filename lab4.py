...
while True:
    ...
    if kom[0]=='sozp':
        ...
        print("sozp - создание папки, delp - удаление папки, kud - куда перейти, sozf - создание файла, delf - удаление файла, zap - запись информации в файл, sod - прочесть файл, per - перенос файла, rename - переименование файла")
    elif kom[0]=='exit':
        break
    elif kom[0]=='home':
        print('текущая директория ', os.getcwd())
